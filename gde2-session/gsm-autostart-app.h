...
#define GSM_AUTOSTART_APP_ENABLED_KEY     "X-GDE2-Autostart-enabled"
#define GSM_AUTOSTART_APP_PHASE_KEY       "X-GDE2-Autostart-Phase"
#define GSM_AUTOSTART_APP_PROVIDES_KEY    "X-GDE2-Provides"
#define GSM_AUTOSTART_APP_STARTUP_ID_KEY  "X-GDE2-Autostart-startup-id"
#define GSM_AUTOSTART_APP_AUTORESTART_KEY "X-GDE2-AutoRestart"
#define GSM_AUTOSTART_APP_DBUS_NAME_KEY   "X-GDE2-DBus-Name"
#define GSM_AUTOSTART_APP_DBUS_PATH_KEY   "X-GDE2-DBus-Path"
#define GSM_AUTOSTART_APP_DBUS_ARGS_KEY   "X-GDE2-DBus-Start-Arguments"
#define GSM_AUTOSTART_APP_DISCARD_KEY     "X-GDE2-Autostart-discard-exec"
#define GSM_AUTOSTART_APP_DELAY_KEY       "X-GDE2-Autostart-Delay"
