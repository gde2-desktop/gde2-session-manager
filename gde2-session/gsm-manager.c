...
#define SESSION_SCHEMA               "org.gde2.session"
#define KEY_IDLE_DELAY               "idle-delay"
#define KEY_AUTOSAVE                 "auto-save-session"

#define SCREENSAVER_SCHEMA           "org.gde2.screensaver"
...
manager_perhaps_lock (GsmManager *manager)
{
        ...
        /* only lock if gde2-screensaver is set to lock */
        ...
        error = NULL;
        ret = g_spawn_command_line_sync ("gde2-screensaver-command --lock", NULL, NULL, NULL, &error);
        if (!ret) {
...
gsm_manager_init (GsmManager *manager)
{
        ...
        /* check if gde2-screensaver is installed */
