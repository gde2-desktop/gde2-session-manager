...
#define GSM_SCHEMA "org.gde2.session"
...
#define GDE2_INTERFACE_SCHEMA "org.gde2.interface"
...
static void set_overlay_scroll (void)
{
	...
	settings = g_settings_new (GDE2_INTERFACE_SCHEMA);
...
int main(int argc, char** argv)
{
	...
	error = NULL;
	gtk_init_with_args(&argc, &argv, (char*) _(" - the GDE2 session manager"), entries, GETTEXT_PACKAGE, &error);
	...
	if (g_getenv ("XDG_CURRENT_DESKTOP") == NULL)
		gsm_util_setenv ("XDG_CURRENT_DESKTOP", "GDE2");
	...
	/* Some third-party programs rely on GDE2_DESKTOP_SESSION_ID to
	 * detect if GDE2 is running. We keep this for compatibility reasons.
	 */
	gsm_util_setenv("GDE2_DESKTOP_SESSION_ID", "this-is-deprecated");
